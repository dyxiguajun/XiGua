...
轻量工具：生成个人简介（Markdown/HTML）与静态博客页面。

- 站点: https://dyxiguajun.github.io/XiGua/
- 文档站点（线上）：https://dyxiguajun.github.io/XiGua/docs/
- 详细文档: `docs/README.md`
- 联系: https://space.bilibili.com/402631059?spm_id_from=333.1007.0.0
...
更多用法与部署示例请查看 `docs/README.md` 或仓库根目录的 `USAGE.md`。